...
function sz_PrintScriptStyle()
{
	...
	$html .= "hs.addSlideshow({ \r\n";
	$html .= "	interval: 5000, repeat: false, useControls: true, fixedControls: true, \r\n";
	$html .= " overlayOptions: { opacity: .6, position: 'top center',	hideOnMouseOut: true } });  \r\n";
