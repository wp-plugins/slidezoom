...
{
	$r="";
	if (is_dir(get_home_path().'/wp-content/plugins/slidezoom/tmp/') && is_writable(get_home_path().'/wp-content/plugins/slidezoom/tmp/') ) 
	{ 
		chmod(get_home_path().'/wp-content/plugins/slidezoom/tmp/', 0777);
