...
function PrintHeader() {
		...
		echo "<script type=\"text/javascript\" src='".get_bloginfo('wpurl')."/wp-content/plugins/slidezoom/js/jquery.blockUI.js'></script>\r\n";
		echo "<script type=\"text/javascript\" src='".get_bloginfo('wpurl')."/wp-content/plugins/slidezoom/js/jquery.MetaData.js'></script>\r\n";
		echo "<link rel=\"stylesheet\" type=\"text/css\" href='".get_bloginfo('wpurl')."/wp-content/plugins/slidezoom/js/MultiFile.css' />\r\n";
print <<<SCRIPT
<style type="text/css">
...
<script type="text/javascript">
		...
		$(function(){ 
			...
			STRING :{
				...
				remove: '<img src="http://test.miawork.com/wp-content/plugins/slidezoom/js/delete.gif" height="16" width="16" alt="ddx"/>' 
			  }
			}); 
		});
