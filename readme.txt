...
IMPORTANT : After upgrade SlideZoom, please go to SlideZoom setting page , check all setting then save one time to complete the upgrade.`
...
`1.1.1	2009/4/17	
Changed : This version is maintenance release. I suggest everyone should update to this version.Fixed "Stack overflow in IE6 / IE7 / IE8" Javascript error alert.	
